...
%%TODO: implemented using http servlet to handle user requests and responses.
...
%%TODO: Add table for explaining each classes in the whole project like i tis done in the example project
