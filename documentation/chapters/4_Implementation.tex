...
\begin{table}[h]
    ...
    \begin{tabular}{|>{\arraybackslash}p{0.33\linewidth}|>{\arraybackslash}p{0.66\linewidth}|}
        \hline
...
\begin{table}[h]
    \centering
    \renewcommand{\arraystretch}{1.5} % Adjusts the row height
    \begin{tabular}{|>{\raggedright\arraybackslash}p{0.3\linewidth}|>{\raggedright\arraybackslash}p{0.1\linewidth}|>{\raggedright\arraybackslash}p{0.6\linewidth}|}
        \hline
        \textbf{Class} & \textbf{Sub-package} & \textbf{Description} \\
        \hline
        MediaContentDAO & interfaces & Description for Class A \\
        \hline
        ReviewDAO B & interfaces & Description for Class B \\
        \hline
        UserDAO & interfaces & Description for Class C \\
        \hline
        AnimeDAOMongoImpl & mongo & Description for Class D \\
        \hline
        BaseMongoDBDAO & mongo & Description for Class E \\
        \hline
        MangaDAOMongoImpl & mongo & Description for Class E \\
        \hline
        ReviewDAOMongoImpl & mongo & Description for Class E \\
        \hline
        UserDAOMongoImpl & mongo & Description for Class E \\
        \hline
        AnimeDAONeo4jImpl & neo4j & Description for Class E \\
        \hline
        BaseNeo4jDAO & neo4j & Description for Class E \\
        \hline
        MangaDAONeo4jImpl & neo4j & Description for Class E \\
        \hline
        UserDAONeo4jImpl & neo4j & Description for Class E \\
        \hline
        DAOLocator &  & Description for Class E \\
        \hline
    \end{tabular}
    \label{tab:mytable}
\end{table}
...
\begin{table}[h]
    \centering
    \renewcommand{\arraystretch}{1.5} % Adjusts the row height
    \begin{tabular}{|>{\raggedright\arraybackslash}p{0.25\linewidth}|>{\raggedright\arraybackslash}p{0.15\linewidth}|>{\raggedright\arraybackslash}p{0.6\linewidth}|}
        \hline
        \textbf{Class} & \textbf{Sub-package} & \textbf{Description} \\
        \hline
        AnimeDTO & mediaContent & Description for Class A \\
        \hline
        MangaDTO B & mediaContent & Description for Class B \\
        \hline
        MediaContentDTO & interfaces & mediaContent for Class C \\
        \hline
        DashboardDTO & statistics & Description for Class D \\
        \hline
        MongoDBStats & statistics & Description for Class E \\
        \hline
        LoggedUserDTO &  & Description for Class E \\
        \hline
        PageDTO &  & Description for Class E \\
        \hline
        REviewDTO &  & Description for Class E \\
        \hline
        UserRegistrationDTO &  & Description for Class E \\
        \hline
        UserSummaryDTO &  & Description for Class E \\
        \hline
    \end{tabular}
    \label{tab:mytable}
\end{table}
...
\begin{table}[h]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{0.25\linewidth}|>{\raggedright\arraybackslash}p{0.15\linewidth}|>{\raggedright\arraybackslash}p{0.6\linewidth}|}
        ...
        \textbf{Class} & \textbf{Sub-package} & \textbf{Description} \\
        \hline
        Anime & mediaContent & Description for Class A \\
        \hline
        Manga B & mediaContent & Description for Class B \\
        \hline
        MangaAuthor & mediaContent & mediaContent for Class C \\
        \hline
        MediaContent & mediaContent & Description for Class D \\
        \hline
        Manager & registeredUser & Description for Class E \\
        \hline
        RegisteredUSer & registeredUser & Description for Class E \\
        \hline
        User & registeredUser & Description for Class E \\
        \hline
        Review &  & Description for Class E \\
        \hline
    \end{tabular}
    \label{tab:mytable}
\end{table}
...
\begin{table}[h]
    \centering
    \renewcommand{\arraystretch}{1.5} % Adjusts the row height
    \begin{tabular}{|>{\raggedright\arraybackslash}p{0.3\linewidth}|>{\raggedright\arraybackslash}p{0.2\linewidth}|>{\raggedright\arraybackslash}p{0.5\linewidth}|}
        \hline
        \textbf{Class} & \textbf{Sub-package} & \textbf{Description} \\
        \hline
        CreateMediaTask & impl/ asinc\_media\_tasks & Description for Class A \\
        \hline
        DeleteMediaTask B & impl/ asinc\_media\_tasks & Description for Class B \\
        \hline
        RefreshLatestReviewsTasks & impl/ asinc\_media\_tasks & mediaContent for Class C \\
        \hline
        UpdateAverageRatingTask & impl/ asinc\_media\_tasks & Description for Class D \\
        \hline
        UpdateMediaRedundancyTask & impl/ asinc\_media\_tasks & Description for Class E \\
        \hline
        UpdateMediaTask & impl/ asinc\_media\_tasks & Description for Class E \\
        \hline
        UpdateNumberofLikesTask & impl/ asinc\_media\_tasks & Description for Class E \\
        \hline
        RemoveDeletedMedia ReviewsTask &impl/ asinc\_review\_tasks  & Description for Class E \\
        \hline
        RemoveDeletedUser ReviewsTask & impl/ asinc\_review\_tasks & Description for Class E \\
        \hline
        UpdateReviewRedundancyTask & impl/ asinc\_review\_tasks & Description for Class E \\
        \hline
        CreateUserTask & impl/ asinc\_user\_tasks & Description for Class E \\
        \hline
    \end{tabular}
    \label{tab:mytable}
\end{table}
...
\begin{table}[h]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{0.3\linewidth}|>{\raggedright\arraybackslash}p{0.2\linewidth}|>{\raggedright\arraybackslash}p{0.5\linewidth}|}
        \hline
        DeleteUserTask & impl/ asinc\_user\_tasks & Description for Class A \\
        \hline
        UpdateNumberOfFollowedTask B & impl/ asinc\_user\_tasks & Description for Class B \\
        \hline
        UpdateNumberOfFollowersTask & impl/ asinc\_user\_tasks & mediaContent for Class C \\
        \hline
        UpdateUserTask & impl/ asinc\_user\_tasks & Description for Class D \\
        \hline
        AperiodicExecutor TaskServiceImpl & impl & Description for Class E \\
        \hline
        ErrorTaskManager & impl & Description for Class E \\
        \hline
        MediaContentServiceImpl & impl & Description for Class E \\
        \hline
        PeriodicExecutor TaskServiceImpl &impl  & Description for Class E \\
        \hline
        ReviewServiceImpl & impl & Description for Class E \\
        \hline
        UserServiceImpl & impl & Description for Class E \\
        \hline
        ExecutorTaskService &interfaces & Description for Class E \\
        \hline
        MediaContentService &interfaces & Description for Class E \\
        \hline
        ReviewService &interfaces & Description for Class E \\
        \hline
        Task &interfaces & Description for Class E \\
        \hline
        TaskManager &interfaces & Description for Class E \\
        \hline
        UserService &interfaces & Description for Class E \\
        \hline
        ServiceLocator & & Description for Class E \\
        \hline
    \end{tabular}
    \label{tab:mytable}
\end{table}
