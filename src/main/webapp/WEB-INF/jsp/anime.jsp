        ...
        <div class="nav-items">
            ...
            <c:choose>
                <c:when test="${isLogged}">
                    <div class="logout" onclick="logout('anime?mediaId=${media.id}')">
            ...
            <div class="main-div container">
                <div class="sidebar">
                    <div class="data">
                        ...
                        <c:if test="${not empty media.year}"><div class="data-set"><div class="type">Season</div><div class="value"><c:choose><c:when test="${empty media.season}"><c:out value="${media.year}" /></c:when><c:otherwise><c:out value="${media.season} ${media.year}" /></c:otherwise></c:choose></div></div></c:if>
                        <c:if test="${not empty media.episodeCount}"><div class="data-set"><div  class="type">Episodes</div> <div class="value"><c:out value="${media.episodeCount}"/></div></div></c:if>
                        ...
                        <c:if test="${not empty media.studios}"><div class="data-set"><div  class="type">Studios</div> <div class="value">Madhouse</div></div></c:if>
                        <c:if test="${not empty media.producers}"><div class="data-set"><div  class="type">Producers</div> <div class="value">Madhouse</div></div></c:if>
                        <c:if test="${not empty media.tags}"><div class="data-set data-list"><div  class="type">Tags</div> <div class="value"><c:forEach var="tag" items="${media.tags}" varStatus="status"><div class="tag"><c:out value="${tag}"/></div><c:if test="${not status.last}"><br /></c:if></c:forEach></div></div></c:if>
                    </div>
                    <c:if test="${isLogged and not isManager}">
                        <c:choose>
