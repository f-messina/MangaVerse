...
/**
 * Asynchronous task for updating the number of followed users for a user.
 * Priority = 6
 * @see Task
 * @see UserDAO
 * @see User
...
public class UpdateNumberOfFollowingsTask extends Task {
    ...
    /**
     * Constructor for the UpdateNumberOfFollowingsTask.
     *
     * @param userId            The id of the user to update.
     * @param increment         The increment to apply to the number of followed users.
     */
    public UpdateNumberOfFollowingsTask(String userId, int increment) {
        super(6);
    ...
    /**
     * Executes the job of updating the number of followed users for a user.
     *
     * @throws BusinessException    if an error occurs during the update of the number of followed users.
     */
    @Override
    public void executeJob() throws BusinessException {
        try{
            // Update the number of followed users
            mongoDbUserDAO.updateNumOfFollowings(userId, increment);
